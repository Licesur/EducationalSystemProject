...
public class VerificationWorkController {
    ...
    @Autowired
    public VerificationWorkController(VerificationWorkService verificationWorkService, TaskService taskService, StudentService studentService) {
...
//        personValidator.validate(person, bindingResult);//todo
        ...
        verificationWorkService.addTasks(verificationWork, selectedTasks);
