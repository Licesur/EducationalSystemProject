...
CREATE TABLE Tutor(id int PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE Tutor_Student (  tutor_id int REFERENCES Tutor(id),
...
CREATE TABLE TaskType(id int PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE Task(id int PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
                  task_type_id int REFERENCES TaskType(id) ON DELETE set null ,
                  definition varchar NOT NULL,
                  answer varchar(100) NOT NULL);

CREATE TABLE VerificationWork_Task(verification_work_id int REFERENCES VerificationWork (id),
...
INSERT INTO Task(task_type_id, definition, answer)
VALUES (1, 'solve the equation: x^2-5x+6=0; enter the sum of all the roots as answer', '5');
INSERT INTO Task(task_type_id, definition, answer)
VALUES (1, 'solve the equation: x^2-x-6=0; enter the sum of all the roots as answer', '1');
INSERT INTO Task(task_type_id, definition, answer)
VALUES (1, 'solve the equation: x^2-6x+8=0; enter the sum of all the roots as answer', '6');
INSERT INTO Task(task_type_id, definition, answer)
VALUES (1, 'solve the equation: x^2+2x-15=0; enter the sum of all the roots as answer', '-2');
INSERT INTO Task(task_type_id, definition, answer)
VALUES (1, 'solve the equation: x^2-5x-50=0; enter the sum of all the roots as answer', '5');
...
INSERT INTO Task(task_type_id, definition, answer)
VALUES (2, 'find the derivative of a function: y=x^2-5x+6', '2x-5');
INSERT INTO Task(task_type_id, definition, answer)
VALUES (2, 'find the derivative of a function: y=x-5', '1');
INSERT INTO Task(task_type_id, definition, answer)
VALUES (2, 'find the derivative of a function: y=sin(x) + e^(x) + 17x', 'cos(x) + e^(x) + 17');
INSERT INTO Task(task_type_id, definition, answer)
VALUES (2, 'find the derivative of a function: y=3x^3 + const', 'nu chto tam');
INSERT INTO Task(task_type_id, definition, answer)
VALUES (2, 'find the derivative of a function: y=sin(x^2+8x+1)', '(2x+8)cos(x^2+8x+1)');
